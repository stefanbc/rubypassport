...
export function Tabs({ children, ariaLabel }: TabsProps) {
  return (
    <div className="flex-shrink-0 border-b border-gray-200 dark:border-zinc-800">
      <div className="flex items-center gap-2 p-2" role="tablist" aria-label={ariaLabel}>
        {children}
      </div>
    </div>
  );
