            ...
            <div className="flex flex-col sm:flex-row items-center justify-between gap-y-2 gap-x-4">
                ...
                <div className="text-center sm:text-left">
                    <p>
                        ...
                        <span className="sm:hidden">
                            {t("components.footer.copyright_mobile", { year })}
                        </span>
                    </p>
                </div>
                ...
                <div className="flex flex-wrap items-center justify-center sm:justify-end gap-x-4 gap-y-2">
                    <span>
                        ...
                        <a
                            href="https://stefancosma.xyz"
                            className="text-red-600/80 hover:text-red-500 dark:text-red-300/80 dark:hover:text-red-300"
                            target="_blank"
                    ...
                    <div className="flex items-center gap-x-3">
                        ...
                        <a
                            href="https://github.com/stefanbc/rubypassport"
                            className="text-red-600/80 hover:text-red-500 dark:text-red-300/80 dark:hover:text-red-300 flex items-center gap-1"
                            target="_blank"
                            rel="noopener noreferrer"
                        >
                            <svg
