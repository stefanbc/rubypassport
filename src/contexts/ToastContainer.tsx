...
const ToastIcon = ({
    type,
    ...props
}: { type: Toast["type"] } & HTMLAttributes<HTMLDivElement>) => (
    <div {...props}>
...
const toastColorClasses: Record<Toast["type"], string> = {
    ...
    success:
        "bg-green-100 border-green-200 text-green-800 dark:bg-green-900/60 dark:border-green-800/50 dark:text-green-200",
    warning:
        "bg-amber-100 border-amber-200 text-amber-800 dark:bg-amber-900/60 dark:border-amber-800/50 dark:text-amber-200",
